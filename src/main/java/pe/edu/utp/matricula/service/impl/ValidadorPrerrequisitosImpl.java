...
@Service
public class ValidadorPrerrequisitosImpl implements ValidadorPrerrequisitos {

    private final CachePrerrequisitos cachePrerrequisitos;
    private final EstudianteRepository estudianteRepository;

    public ValidadorPrerrequisitosImpl(CachePrerrequisitos cachePrerrequisitos, EstudianteRepository estudianteRepository) {
